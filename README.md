...
However, n-orm still needs you to properly understand the [DataModel], so that you can properly think you data model. You may want to look for HBase or Cassandra tutorials around to  get familiar with this new way of thinking data models.
