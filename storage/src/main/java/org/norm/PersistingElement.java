...
import org.norm.cf.ColumnFamily;
...
public interface PersistingElement extends Comparable<PersistingElement>, Serializable {
	 ...
	 * @see org.norm.conversion.ConversionTools#convertToString(Object)
	 */
	 ...
	 * To know how to define the properties file, please refer to your data store supplier. An (naive) example is the {@link org.norm.memory.Memory} data store.
	 * </p>
