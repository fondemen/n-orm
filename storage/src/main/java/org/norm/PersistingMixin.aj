...
public privileged aspect PersistingMixin {
	...
	pointcut creation(PersistingElement self): execution(org.norm.PersistingElement+.new(..)) && this(self) && if(thisJoinPointStaticPart.getSignature().getDeclaringType().equals(self.getClass()));
