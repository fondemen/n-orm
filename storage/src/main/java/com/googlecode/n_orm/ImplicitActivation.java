 ...
 * When applied to a column family (i.e. properties of type {@link java.util.Map} or {@link java.util.Set}), makes it systematically be activated using {@link PersistingElement#activate(String...)}.
