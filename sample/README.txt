...
To run the project with no HBase instance started, just run maven (maven 2 required):
mvn test
...
For production, you should prefer the variant presented in src/main/resources/com/googlecode/n_orm/sample/business/store.poperties.
...
To run the self-contained jar:
 ...
 - java -jar target/sample-hbase-<HBase version>-n_orm-<n-orm version>-jar-with-dependencies.jar
